...
public class Vista {
    ...
    private void handleQuery1() {
        ...
        System.out.println("Nº de negocios: " + collection.size());
        CommandLineTable clt = new CommandLineTable();
        clt.setHeaders("Ids Negocios");
    ...
    private void handleQuery3() {
        ...
        CommandLineTable clt = new CommandLineTable();
        clt.setHeaders("Mes","Ano","Nº de Avaliacoes","Nº de Negocios","Classificacao");
    ...
    private void handleQuery4() {
        ...
        CommandLineTable clt = new CommandLineTable();
        clt.setHeaders("Mes","Ano","Nº de Avaliacoes","Nº de utilizadores","Classificao");
    ...
    private void handleQuery9() {
        ...
        CommandLineTable clt = new CommandLineTable();
        clt.setHeaders("Id Utilizadores","Nº de Reviews","Avaliação");
    ...
    private void handleQuery10() {
        ...
        CommandLineTable clt = new CommandLineTable();
        clt.setHeaders("Estados","Cidades","Id de Negócios","Avaliação");
    ...
    public void handleEstatisticas(){
        System.out.println(this.controlador.estatisticasString());
    }
